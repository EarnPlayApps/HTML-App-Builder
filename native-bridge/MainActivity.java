...
public class MainActivity extends BridgeActivity {
    ...
    private final class FileBridge {
        ...
        public synchronized void finishResult() throws Exception {
            ...
            if ("download".equals(mode) || "save".equals(mode)) saveToDownloads();
            else shareOrOpen();
        }
        ...
        private void shareOrOpen() throws Exception {
            Uri uri = FileProvider.getUriForFile(MainActivity.this, "com.apkstudio.allconvert.fileprovider", temp);
            Intent intent = "share".equals(mode) ? new Intent(Intent.ACTION_SEND) : new Intent(Intent.ACTION_VIEW);
